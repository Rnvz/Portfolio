...
export const PROJECTS: Project[] = [
  {
    ...
    year       : '2024 - 2025',
    description: 'Two-app production ecosystem for Indonesia\'s leading wine and spirits distributor. Public portal and internal CMS with RBAC and analytics.',
    stack      : ['Next.js 15', 'React 19', 'TypeScript', 'Tailwind v4', 'Cloudflare D1', 'Resend'],
  ...
  },
  {
    ...
    stack      : ['React TS', 'TailwindCSS', 'Node.js', 'Prisma ORM', 'SQLite', 'Figma'],
  ...
  },
  {
    id         : 'nofake',
    title      : 'NoFake',
    subtitle   : 'Hoax Verification & Education Platform',
    role       : 'UI/UX & Frontend Developer',
    year       : '2023',
    ...
    image      : '/projects/pni-portal.webp', // placeholder
    featured   : false,
    live       : null,
    github     : 'https://github.com/Rnvz',
  },
  {
    ...
    stack      : ['Figma', 'HTML5', 'CSS3', 'JavaScript', 'Git'],
    image      : '/projects/serenity.webp', // placeholder
    featured   : false,
    live       : null,
    github     : 'https://github.com/Rnvz',
  },
